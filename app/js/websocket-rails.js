...
(function() {
  ...
  this.WebSocketRails = (function() {
    ...
    WebSocketRails.prototype.subscribe = function(data, success_callback, failure_callback) {
    ...
    WebSocketRails.prototype.subscribe_private = function(data, success_callback, failure_callback) {
      var channel, channel_name;
      if (typeof data === 'string') {
        channel_name = data;
      } else {
...
(function() {
  WebSocketRails.Event = (function() {
    Event.prototype.SUCCEEDED = 0;

    Event.prototype.FAILED = 1;

    Event.prototype.FINISHED_WITHOUT_FAILURE = 2;
...
(function() {
  ...
  WebSocketRails.Channel = (function() {
    function Channel(data1, _dispatcher, is_private, on_success, on_failure) {
